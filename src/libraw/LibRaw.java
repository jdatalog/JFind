...
public interface LibRaw extends Library {
    ...
    public LibRaw INSTANCE = (LibRaw) Native.load("raw_tophe", LibRaw.class);
     ...
     * component). The thumbnail format is written to the
     * imgdata.thumbnail.tformat field; for the possible values, see description
    ...
    libraw_processed_image_t libraw_dcraw_make_mem_thumb(LibRawData lr, IntByReference errc);
     ...
     * imgdata.params) is supported, except for dark frame subtraction and work
     * with bad pixels. The function is intended solely for demonstration and
     * testing purposes; it is assumed that its source code will be used in most
     * real applications as the reference material concerning the order of RAW
     * data processing.
     *
     * @param lr
     * @return
